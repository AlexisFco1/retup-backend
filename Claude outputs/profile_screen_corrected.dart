...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadData() async {
    try {
      ...
      // Cargar feedback general (para mantener compatibilidad si se necesita)
      final score =
      ...
      // Cargar feedback score POR RETO
      _feedbackScoresPerReto.clear();
      for (var retoLocal in retoProvider.retos) {
        try {
          final feedbackScore = await _feedbackService.calculateUserFeedbackScore(
            userId,
            token,
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          // Sección de Calificación (TITULO MANTENIDO)
                          Text('Calificación',
                              style: TextStyle(
                                  fontSize: 14,
                          ...
                          // TARJETA GENERAL ELIMINADA - AQUI SOLO VA ESPACIADO
                          const SizedBox(height: 32),
                                          ...
                                          children: [
                                            ...
                                            RichText(
                                              text: TextSpan(
                                                children: [
                                                  TextSpan(
                                                      text: (_feedbackScoresPerReto[retoLocal.reto.id] ?? 0.0)
                                                          .toStringAsFixed(0),
                                                      style: const TextStyle(
                                                          fontSize: 72,
                                                          fontWeight:
                                            ...
                                            ClipRRect(
                                              ...
                                              child: LinearProgressIndicator(
                                                value: (_feedbackScoresPerReto[retoLocal.reto.id] ?? 0.0) / 100,
                                                minHeight: 8,
                                                backgroundColor:
                                                    Colors.grey[200],
                                                valueColor:
